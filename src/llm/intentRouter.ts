...
export async function classifyIntent(userText: string): Promise<IntentResult> {
    const systemPrompt = [
        'You are an intent classifier for a scheduling assistant.',
        'You must respond with VALID JSON only, no extra text.',
        'Supported intents: "book_appointment", "show_appointment_history", "show_upcoming_appointments", "reschedule_appointment", "show_appointment_summary", or "unknown".',
        ...
        'You are NOT responsible for designing UI. Only classify intent.',
        'JSON format:',
        '{',
        '  "intent": "book_appointment" | "show_appointment_history" | "show_upcoming_appointments" | "reschedule_appointment" | "show_appointment_summary" | "unknown",',
        '  "confidence": 0.0-1.0',
        '}',
    ].join('\n');
